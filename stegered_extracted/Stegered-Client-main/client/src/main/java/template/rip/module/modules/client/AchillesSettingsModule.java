...
public class AchillesSettingsModule extends Module {
    ...
    // Echo takes the former Glass index so existing default profiles migrate to
    // the copied ECHO look without disturbing Flat and Moon profile indexes.
    public enum styleEnum {Echo, Flat, Moon, Glass}

    public final ModeSetting<styleEnum> clickGuiStyle = new ModeSetting<>(this, styleEnum.Echo, "ClickGUI Style");
    public final BooleanSetting echoDarkMode = new BooleanSetting(this, true, "Echo Dark Mode");
    public final BooleanSetting echoDock = new BooleanSetting(this, true, "Echo Navigation Dock");
    public final NumberSetting echoPanelOpacity = new NumberSetting(this, 0.78, 0.25, 1.0, 0.01, "Echo Panel Opacity");
    ...
    public final ColorSetting color = new ColorSetting(this, new JColor(0, 122, 255), false, "Color");
...
//    public final BooleanSetting dontStopParty = new BooleanSetting("Don't stop the partehhh!!!!!", this, false);
    ...
    public AchillesSettingsModule(Category category, Description description, String name) {
        ...
        echoDarkMode.addConditionMode(clickGuiStyle, styleEnum.Echo);
        echoDock.addConditionMode(clickGuiStyle, styleEnum.Echo);
        echoPanelOpacity.addConditionMode(clickGuiStyle, styleEnum.Echo);
