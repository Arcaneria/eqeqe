...
/**
 * Creates and registers every client module.
 *
 * <p>Registration is deliberately independent of UI and authentication so the
 * complete client is available as soon as Minecraft starts.</p>
 */
public final class ModuleRegistry {
    ...
    public static void registerAll(ModuleManager moduleManager) {
        ...
        moduleManager.addModule(new AchillesSettingsModule(Module.Category.CLIENT, Description.of("Stegered Client settings"), "StegeredClient"));
        moduleManager.addModule(new BallsModule(Module.Category.CLIENT, Description.of("Renders balls"), "Balls"));
        moduleManager.addModule(new ClickSimulationModule(Module.Category.CLIENT, Description.of("Manages Stegered Client click simulation"), "ClickSimulation"));
        moduleManager.addModule(new ClientDestructModule(Module.Category.CLIENT, Description.of("Removes traces"), "SelfDestruct"));
        moduleManager.addModule(new ConfigModule(Module.Category.CLIENT, Description.of("Stegered Client configuration"), "Config"));
        ...
        moduleManager.addModule(new SmartAutoAnchorModule(Module.Category.CRYSTAL, Description.of("Charges the placed anchor, then watches manual POV movement to choose normal or safe behavior\nStrict server timing prevents same-tick action bursts; a totem is not required"), "SmartAutoAnchor"));
        ...
        moduleManager.addModule(new EchoAutoCrystalModule(Module.Category.CRYSTAL, Description.of("ECHO's crosshair-driven Auto Crystal with integrated Place Obsidian sequencing"), "EchoAutoCrystal"));
        moduleManager.addModule(new EchoAutoAnchorModule(Module.Category.CRYSTAL, Description.of("ECHO's anchor automation: optimal placement near your target, charged and detonated with Grim DuplicateRotPlace-aware timing, optional safety block, silent aim and silent slot swapping"), "EchoAutoAnchor"));
        ...
        moduleManager.addModule(new PreventModule(Module.Category.MISC, Description.of("Prevents accidental crystal PvP actions"), "Prevent"));
